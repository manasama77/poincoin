                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
                                <tr>
                                    <td style="color: #153643; font-family: Arial, sans-serif; text-align: center;">
                                        <h1 style="font-size: 24px; margin: 0;">Account Number Has Been Reset</h1>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 24px; padding: 20px 0 30px 0; text-align:center;">
                                        <h4>Your Old Account Number Has Been Change To:</h4>
                                        <h4><mark><?= $no_rekening; ?> <?= $nama_bank; ?> a/n <?= $atas_nama; ?></mark></h4>
                                        <h5>Jika kamu tidak melakukan proses penggantian No Rekening, silahkan segera hubungi Admin via Whatsapp untuk melakukan reset ulang No Rekening kamu.</h5>
                                    </td>
                                </tr>
                            </table>
                        </td>
