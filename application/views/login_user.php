                    ...
                    <div class="card card-custom">
                        ...
                        <div class="card-body">
                            ...
                            <form class="form-signin mt-3" action="<?= site_url(); ?>" method="post">
                                ...
                                <a href="<?= site_url(); ?>signup_user" class="btn btn-sm btn-warning btn-block text-uppercase btn-flat"><span style="color: red">Didn't Have Account ?</span> <span style="color: black">Sign Up</span></a>
                            </form>
                        </div>
                    </div>
                </div>
