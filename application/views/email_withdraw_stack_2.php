                                ...
                                <tr>
                                    <td style="color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 24px; padding: 20px 0 30px 0; text-align:center;">
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse; font-family: Arial, sans-serif; font-size: 16px; line-height: 24px; text-align: left">
                                            <tr>
                                                <td style="width: 170px;">Withdraw Amount (B)</td>
                                                <td style="width: 10px;">:</td>
                                                <td><?= number_format($withdraw_b, 4); ?> B</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td style="width: 170px;">No Wallet</td>
                                                <td style="width: 10px;">:</td>
                                                <td><?= $no_wallet; ?></td>
                                            </tr>
                                            <tr>
                                                <td colspan="3">
                                                    <ul>
                                                        ...
                                                        <li>Jumlah DOGE Coin yang akan ditransfer mengacu pada Rate DOGE/IDR pada saat Admin melakukan transfer coin</li>
                                                        <li>Pastikan address wallet adalah address untuk DOGE Coin, dikarenakan jika address salah coin yang sudah di transfer akan hangus</li>
                                                    </ul>
                                                </td>
                                            </tr>
                                        </table>
