    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand js-scroll-trigger" href="#page-top">
                <?php echo file_get_contents(base_url() . "public/img/logo_wide_sm.svg"); ?>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav text-uppercase ml-auto">
                    ...
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#about">Token</a></li>
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#team">Roadmap</a></li>
