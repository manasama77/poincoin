                ...
                <form id="form_new_stack">
                    ...
                    <div class="alert alert-info" role="alert">
                        <ul>
                            ...
                            <li>Untuk melakukan transfer bisa di nomor rekening Bank <kbd><?= NAMA_BANK_ADMIN; ?> <?= NO_REKENING_ADMIN; ?> <?= ATAS_NAMA_NO_REKENING_ADMIN; ?></kbd> atau transfer menggunakan <kbd>Tron Coin (TRX)</kbd> ke Nomor Wallet <kbd><?= NO_WALLET_ADMIN; ?></kbd></li>
                        </ul>
                    </div>
