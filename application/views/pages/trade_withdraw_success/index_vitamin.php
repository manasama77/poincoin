...
<script>
	...
	function verifikasiTransfer(id, kode) {
		Swal.fire({
			...
			text: `Kamu akan memverifikasi bioner stacking withdraw dengan kode ${kode}`,
			icon: 'question',
			...
			if (result.isConfirmed) {
				$.ajax({
					url: `<?= site_url(); ?>admin/bioner_stacking_withdraw/verifikasi`,
					method: 'post',
					dataType: 'json',
					data: {
						id: id
	...
	function deleteData(id) {
		Swal.fire({
			...
			if (result.isConfirmed) {
				$.ajax({
					url: `<?= site_url(); ?>admin/bioner_stacking_withdraw/delete`,
					method: 'post',
					data: {
						id: id
					},
