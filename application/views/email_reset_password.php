                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
                                <tr>
                                    <td style="color: #153643; font-family: Arial, sans-serif; text-align: center;">
                                        <h1 style="font-size: 24px; margin: 0;">Password Has Been Reset</h1>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 24px; padding: 20px 0 30px 0; text-align:center;">
                                        <h4>Your Old Password Has Been Change To:</h4>
                                        <h4><mark><?= $password; ?></mark></h4>
                                        <h5>Pastikan kamu menjaga password baru kamu!</h5>
                                        <h5>Jika kamu tidak melakukan proses penggantian password, silahkan segera hubungi Admin via Whatsapp untuk melakukan reset ulang password kamu.</h5>
                                    </td>
                                </tr>
                            </table>
                        </td>
